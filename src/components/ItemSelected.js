        ...
        <div>
            <div className='row'>
                <div className='input-group mb-3' style={{marginLeft:'2rem'}}>
                    ...
                    <spn className="eco" style={{marginLeft:'2rem',marginRight:'8px'}}></spn>
                    <input required='required' type='number' id='cost' value={quantity} style={{size:10}} onChange={e=>setQuantity(e.target.value)} />
